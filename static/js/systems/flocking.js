...
(function() {
  ...
  define(['components/vector', 'components/physics', 'systems/world'], function(Vector, Physics, WorldSystem) {
    var Flocking;
    Flocking = (function() {
      ...
      Flocking.prototype.tick = function(delta) {
        var entity, id, neighbors, _ref;
        _ref = this.entities.entitiesIndex['flocking'];
        for (id in _ref) {
          entity = _ref[id];
          neighbors = WorldSystem.prototype.getNeighborsByCreatureType(entity, this.entities, 6, ['flocking']);
